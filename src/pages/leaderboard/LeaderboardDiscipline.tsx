...
import { LeaderboardResponse, leaderboardQueryOptions } from '@/api/contests'
...
export function LeaderboardDiscipline() {
  ...
  const { data: results } = useSuspenseQuery(leaderboardQueryOptions(discipline as Discipline))
