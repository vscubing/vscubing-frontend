      ...
      if (v && (u = v.events)) {
        ...
        while (l--)
          if (((p = g = (s = De.exec(t[l]) || [])[1]), (h = (s[2] || '').split('.').sort()), p)) {
            ...
            a &&
              !d.length &&
              ((f.teardown && !1 !== f.teardown.call(e, h, v.handle)) || ce.removeEvent(e, p, v.handle), delete u[p])
      ...
      e && e.type
        ? ((this.originalEvent = e),
          ...
          (this.isDefaultPrevented =
            e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? Ne : Le),
      ...
      ;(ce.event.special[r] = {
        ...
        (ce.event.special[i] = {
          ...
          teardown: function () {
            ...
            n
              ? _.set(t, i, n)
              : (m.documentMode ? this.removeEventListener(i, o) : e.removeEventListener(r, o, !0), _.remove(t, i))
          },
        })
    }),
    ce.each(
        ...
        set: function (e, t, n) {
          ...
          return (
            a &&
              o &&
              (s -= Math.ceil(
                e['offset' + u[0].toUpperCase() + u.slice(1)] - parseFloat(i[u]) - ot(e, u, 'border', !1, i) - 0.5,
              )),
